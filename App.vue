...
const ogImagePath = '/img/index/logo-desk.png';
...
useHead(() => {
  ...
  if (import.meta.server) {
    try {
      ...
      ogImageUrl = `${requestURL.origin}${ogImagePath}`;
    } catch {
      ogImageUrl = (process.env.NUXT_PUBLIC_SITE_URL || 'https://avalonbali.com') + ogImagePath;
    }
  ...
  return {
    ...
    meta: [
      ...
      { property: 'og:image:alt', content: 'Avalon Logo' },
