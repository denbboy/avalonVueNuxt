<template>
  <Head>
    <Title>
      {{
        itemData?.translations?.filter((item) => item.languages_code.includes(langStore.lang))[0]
          ?.meta_title
      }}
    </Title>
    <Meta
  ...
  <section class="bg-blue-500 pt-32 md:pt-64 relative overflow-hidden">
    ...
    <div
      class="bg-gradient-to-t from-blue-500 rotate-180 top-0 from-40% w-full h-[300px] opacity-70 absolute z-10"
    ></div>
    <div
      class="bg-gradient-to-t from-blue-500 top-[calc(1000px_-_700px)] from-70% w-full h-[1000px] absolute z-10"
    ></div>
    ...
    <div class="container relative z-10">
      <div class="pb-14">
        ...
        <div class="md:flex justify-between w-full">
          <div
            class="text-content max-w-[900px] block w-full"
            v-html="
          ...
          <div class="max-w-[508px] mt-14 md:mt-0 w-full" v-if="projectInclude?.id">
            ...
            >
              <div class="">
                <NuxtImg
                  v-if="projectInclude?.preview"
                  :src="`https://api.avalonbali.com/assets/${projectInclude?.preview}?width=470&height=600`"
                  class="opacity-50 w-full absolute object-cover h-full"
                  alt="Image"
                  loading="lazy"
                />
                <div
                  class="bg-gradient-to-t from-blue-600 absolute bottom-0 left-0 w-full h-3/4"
                ></div>
                <div class="absolute top-0 left-0 w-full h-full p-5 md:p-7 flex flex-col">
                  ...
                  <div class="flex justify-between mb-auto">
                    ...
                    >
                      <svg
                        class="absolute w-full h-full top-0 left-0 right-0"
                        viewBox="0 0 101 29"
                        fill="none"
                            ...
                            <div class="absolute top-0 left-0 w-full h-full p-5 md:p-7 flex flex-col">
                                ...
                                <div class="max-w-96">
                                    ...
                                    <div class="flex items-center mb-5 md:mb-7">
                                        <strong class="text-xl md:text-2xl text-white mr-[6px]">от {{ formatAmount(convertUsdToIdr(120000)) }} ₽</strong>
                                        <span class="text-white/60 text-[12px] hidden md:block">120 000 $ {{ $t('in_usd') }}</span>
                                    </div>
      ...
      <div class="">
        <div class="flex justify-between items-center mb-8">
          ...
          <div class="w-fit hidden md:flex">
            ...
            <button
              type="button"
              class="transition-all opacity-20 hover:opacity-100 sales-button-next"
            >
              <svg
                width="22"
                height="24"
