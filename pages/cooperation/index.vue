<template>
  <main class="overflow-hidden">
    ...
    <section
      v-for="item in cooperationFetch.data.value"
      :id="item.id"
    ...
    >
      <div class="container">
        <div
          class="xl:flex text-photo xl:items-center justify-between gap-6 3xl:gap-[80px] mb-8 xl:mb-20"
        >
          <div data-aos="fade-right" class="w-full">
            ...
            <p
              class="text-sm text-white mb-8 md:mb-12 md:text-lg"
              v-html="
                item.translations.find((i) => i.languages_code.includes(langStore.lang)).description
              "
            ></p>
            <button
              @click="
              ...
              "
              class="white-button hidden xl:block"
            >
              {{ $t('start_cooperation') }}
            </button>
          </div>
          <NuxtImg
            ...
            :src="'https://api.avalonbali.com/assets/' + item.photo"
            alt="img"
          />
        </div>
        <div
        ...
        >
          ...
          >
            <li class="flex gap-5 mb-8 last:mb-0 md:mb-0">
              ...
              >
                <img
                  loading="lazy"
                  class="w-3 h-3 md:w-auto md:h-auto"
          ...
          <ol v-else class="md:grid md:grid-cols-4 relative justify-between">
            <li class="flex gap-5 md:gap-0 md:flex-col items-center z-10 mb-5 last:mb-0">
              ...
              <p
                class="text-sm md:text-base text-white md:px-1 md:max-w-[295px] md:text-center md:ml-0"
              >
                {{
                  item.translations.find((i) => i.languages_code.includes(langStore.lang))
                    .first_subtitle_text
...
const handleOpenModal = (title) => {
  modalsStore.addModal('cooperation');
...
const pageData = pageDataFetch.data.value
