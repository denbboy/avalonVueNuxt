<template>
    <main class="overflow-hidden">
            ...
            <div class="container mx-auto relative z-20 pt-32 md:pt-64">
                ...
                <div data-aos="fade-up" class="grid lg:grid-cols-4 lg:gap-5">
                    <button
                        ...
                        <img class="absolute lg:group-hover:hidden hidden top-0 lg:block h-full w-full"
                            src="/assets/img/cooperation/border-bgd.svg" alt="">
                        <img class="absolute lg:group-hover:block hidden top-0 lg:hidden h-full w-full"
                            src="/assets/img/cooperation/border-bgd-hover.svg" alt="">

                        <div
                            class="flex items-center justify-center lg:p-4 lg:bg-blue-400 lg:w-fit lg:rounded-[20px] lg:mx-auto lg:mt-[-75px]">
                            <img src="/assets/img/cooperation/banner-block-icon-1.svg" alt="img">
                        </div>
                        <div class="relative z-10">
                            <p class="my-4 text-white font-bold text-center">Брокерам</p>
                            <img class="mx-auto" src="/assets/img/icons/double-arrow-down-white.svg" alt="img">
                        </div>
                    </button>
                    <button
                        class="border cursor-pointer group relative lg:h-[172px] mb-[10px] last:mb-0 lg:border-none border-white/50 rounded-[10px] py-8 bg-no-repeat w-full">
                        ...
                        <div
                            class="flex items-center justify-center lg:p-4 lg:bg-blue-400 lg:w-fit lg:rounded-[20px] lg:mx-auto lg:mt-[-75px]">
                            <img src="/assets/img/cooperation/banner-block-icon-2.svg" alt="img">
                        </div>
                        <div class="relative z-10">
                    ...
                    <button
                        ...
                        <div
                            class="flex items-center justify-center lg:p-4 lg:bg-blue-400 lg:w-fit lg:rounded-[20px] lg:mx-auto lg:mt-[-75px]">
                            <img src="/assets/img/cooperation/banner-block-icon-3.svg" alt="img">
                        </div>
                        <div class="relative z-10">
                            <p class="my-4 text-white font-bold text-center">
                                Маркетингу
                    ...
                    <button
                        ...
                        <div
                            class="flex items-center justify-center lg:p-4 lg:bg-blue-400 lg:w-fit lg:rounded-[20px] lg:mx-auto lg:mt-[-75px]">
                            <img src="/assets/img/cooperation/banner-block-icon-4.svg" alt="img">
                        </div>
                        <div class="relative z-10">
                            <p class="my-4 text-white font-bold text-center">
                                Партнерство
        ...
        <section class="py-[60px] lg:py-[100px]">
            <div class="container">
                <div class="md:flex md:flex-row-reverse md:items-center gap-[80px] mb-8 md:mb-20">
                    <div data-aos="fade-left" class="">
                        ...
                        <p class="text-sm text-white mb-8 md:mb-12 md:text-lg">Мы ценим вклад тех, кто помогает развитию
                            ...
                            брокерами,
                            основанную на доверии, открытости и взаимной прибыли. Наши партнеры-брокеры получают самые
                            выгодные
        ...
        <section class="py-[60px] lg:py-[100px] bg-blue-600">
            <div class="container">
                <div class="md:flex md:flex-row md:items-center gap-[80px] mb-8 md:mb-20">
                    <div data-aos="fade-right" class="">
                        ...
                        <p class="text-sm text-white mb-8 md:mb-12 md:text-lg">Для сотрудничества с риелторами мы
                            разработали
                            инновационную программу, которая позволяет сертифицированным агентствам недвижимости
                            официально
                ...
                <p data-aos="fade-up" class="hidden md:block text-white text-lg max-w-[892px] mt-12">Для обеспечения
        ...
        <section class="py-[60px] lg:py-[100px] bg-blue-500">
            <div class="container">
                <div class="md:flex md:flex-row-reverse md:items-center gap-[80px] mb-8 md:mb-20">
                    <div data-aos="fade-left" class="">
                        ...
                        <p class="text-sm text-white mb-8 md:mb-12 md:text-lg">Знакомы с нашими проектами и у вас есть
                            ...
                            полиграфией или изготовлением качественных POS-материалов, если вы гуру в организации
                            ивентов
                            или
                ...
                <div class="md:flex md:flex-row md:items-center gap-[80px] mb-8 md:mb-20">
                    <div data-aos="fade-right" class="">
                        ...
                        <p class="text-sm text-white mb-8 md:mb-12 md:text-lg">
                            Мы готовы взять на себя комплексную или частичную реализацию проекта в случае, если цели,
                            миссия
                            и
