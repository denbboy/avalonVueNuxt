...
<template>
    <section class="pb-12">
        <div class="swiper-slide pb-10 pt-36 lg:pt-[290px] relative overflow-hidden">
            <div
                class="bg-[url('./../img/about/about-banner.jpg')] max-w-none bg-center absolute top-0 left-0 w-full h-screen -z-10 opacity-50">
            </div>
            ...
            <div class="container">
                <div class="md:flex md:justify-between md:gap-10">
                    <div>
                        <div class="banner__item__head flex flex-wrap items-center gap-[10px] md:gap-5">
                            <div
                    ...
                    <div class="flex flex-col md:mt-10">
                        ...
                        <div class="flex gap-[10px] md:gap-5 md:mt-[100px] lg:grid lg:grid-cols-[repeat(3,_240px)]">
        ...
        <div class="container">
            <div
                ...
                <img src="/assets/img/about/phone-mob.png" class="absolute top-[-40px] right-[-30px] lg:hidden"
                    alt="ph">
                <div>
                    <h2 class="font-bold text-white text-3xl mb-7 md:text-[56px] md:mb-[50px]">
                        Чангу
                    </h2>
                    <div class=" mb-5 md:mb-[30px] md:flex md:gap-2">
                    ...
                    <p class="text-white text-sm mb-5 max-w-[225px] md:text-[18px] md:max-w-none md:mb-[30px]">
                        В 2019 году Forbes поставил Чангу на 41-е место в ТОп-местах на планете для жизни и
                        инвестирования.
                    </p>

                    <div
                        class="p-5 border border-blue-400 rounded-[20px] mb-5 md:p-[30px] md:max-w-[505px] md:mb-[30px]">
                        <p class="text-white text-sm md:text-[18px] ">
                            <span class="md:font-bold">Чангу:</span> кусочек рая не только для туристов и эмигрантов, но
                            и
                            для инвесторов.
                        </p>
                    </div>
                    ...
                    <ul class="max-w-[225px] lg:max-w-none">
                        <li class="flex items-center gap-[10px] md:gap-[20px] mb-4 md:mb-5">
                            <img src="/assets/img/about/galka.svg" class="max-w-[15px] md:max-w-none" alt="ic">
                            <p class="text-white text-sm md:text-base">
                                Чангу является одной из главных инвестиционных достопримечательностей на рынке курортной
                                недвижимости Бали.
                            </p>
                        </li>
                        <li class="flex items-center gap-[10px] md:gap-[20px] mb-4 md:mb-5">
                            <img src="/assets/img/about/galka.svg" class="max-w-[15px] md:max-w-none" alt="ic">
                            <p class="text-white text-sm md:text-base">
                                Средняя заполняемость в Чангу от 70%
                            </p>
                        </li>
                        <li class="flex items-center gap-[10px] md:gap-[20px] mb-4 md:mb-5">
                            <img src="/assets/img/about/galka.svg" class="max-w-[15px] md:max-w-none" alt="ic">
                            <p class="text-white text-sm md:text-base">
                                Среднегодовой рост стоимости недвижимости в этом районе составляет 20%
                            </p>
                        </li>
                        <li class="flex items-center gap-[10px] md:gap-[20px] mb-4 md:mb-5">
                            <img src="/assets/img/about/galka.svg" class="max-w-[15px] md:max-w-none" alt="ic">
                            <p class="text-white text-sm md:text-base">
                                За 4 года стоимость земли выросла более чем на 300%
                            </p>
                        </li>
                        <li class="flex items-center gap-[10px] md:gap-[20px] mb-4 md:mb-5">
                            <img src="/assets/img/about/galka.svg" class="max-w-[15px] md:max-w-none" alt="ic">
                            <p class="text-white text-sm md:text-base">
                                Среднегодовая арендная плата увеличилась на 15% в год
                            </p>
                        </li>
                        <li class="flex items-center gap-[10px] md:gap-[20px]">
                            <img src="/assets/img/about/galka.svg" class="max-w-[15px] md:max-w-none" alt="ic">
                            <p class="text-white text-sm md:text-base">
                                Количество запросов на недвижимость в Чангу растет на 30-40% в год
                            </p>
                        </li>
                    </ul>
                </div>
                <img src="/assets/img/about/tel-desk.png" class="hidden lg:block" alt="ph">
            </div>
        </div>
    </section>
    ...
    <section class="map py-14 md:py-24">
        <div class="container">
            ...
            <div class="overflow-hidden rounded-2xl mb-7 lg:mb-0 lg:rounded-none lg:rounded-t-2xl">
                <img src="/assets/img/about/map.jpg" class="scale-150 lg:scale-100" alt="map ph">
                <a href="#"
                    class="flex relative z-10 gap-[5px] p-3 bg-blue-400 font-bold text-white text-xs justify-center md:text-base md:gap-2">
                    <img src="/assets/img/about/location.svg" class="max-w-[15px] md:max-w-none" alt="location ic">
                    Посмотреть локацию в Google Maps
                </a>
            </div>
            <div
        ...
        <div class="container">
            <div
                ...
                <div
                    ...
                    <span class="text-white font-bold text-lg md:text-3xl">
                        16%
                    </span>
                </div>

                <div
                    class="mySwiper-about relative lg:max-w-[600px] lg:mr-0 lg:ml-auto lg:m-0 lg:rounded-3xl rounded-2xl overflow-hidden">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="/assets/img/about/about-slide-1.jpg" class="rounded-xl w-full" alt="ph">
                        </div>
                        <div class="swiper-slide">
                            <img src="/assets/img/about/about-slide-1.jpg" class="rounded-xl w-full" alt="ph">
                        </div>
                ...
                <div>
                    <div class="mb-8 md:mb-12">
                        <h2 class="font-bold text-white text-3xl mb-[10px] md:text-[56px] md:mb-7">
                            Апартаменты
                        </h2>
                    ...
                    <div class="flex items-center gap-5 mb-7 md:mb-12 max-w-[436px] w-full">
                        <div class="border border-blue-400 p-4 rounded-2xl w-full">
                            <h3 class="font-bold text-white mb-2 md:text-xl md:mb-4 lg:leading-[100%]">
                                42 м²
                            </h3>
                    ...
                    <ul class="grid grid-cols-2 gap-5 max-w-[436px] w-full">
                        <li class="border-b border-whiteOp-300 max-w-[208px] pb-4">
                            <h3
                                class="font-bold text-white mb-2 lg:leading-[100%] md:text-xl md:mb-4 before:block before:h-[6px] before:w-[6px] lg:before:w-[10px] lg:before:h-[10px] lg:before:rounded before:rounded-sm before:bg-blue-400 flex items-center before:mr-2">
                                3 м²
                            </h3>
                            <p class="text-white text-sm md:text-base lg:leading-[120%]">
                                площадь <br>прихожей
    ...
    <section class="cost py-14 md:py-24">
        <div class="container">
            ...
            <div class="lg:grid grid-cols-3 gap-5">
                ...
                <div
                    class="flex items-center gap-5 py-7 border-t border-b border-whiteOp-300 lg:gap-7 lg:py-14 lg:px-10 lg:border lg:rounded-2xl">
            ...
            <div class="">
                <div class="flex w-full">
                    <div class="w-full mb-[15px] md:mb-[30px]">
                        <input type="radio" name="data1" value="op1" id="opcion1" class="sr-only" checked>
                        <label for="opcion1"
                            class="py-[17px] md:py-[23px] px-2 w-full flex justify-center font-bold text-[#FFFFFF66] text-sm md:text-base border-b border-[#FFFFFF66] cursor-pointer">Апартаменты</label>
                    </div>
                    <div class="w-full">
                        <input type="radio" name="data1" value="op2" id="opcion2" class="sr-only">
                        <label for="opcion2"
                            class="py-[17px] md:py-[23px] px-2 w-full flex justify-center font-bold text-[#FFFFFF66] text-sm md:text-base border-b border-[#FFFFFF66] cursor-pointer">Виллы</label>
                    </div>
                </div>

                <div class="bg-blue-600 rounded-2xl px-5 py-[30px] md:p-[50px] ">
                    <div
                    ...
                    <div class="about-scroll w-full overflow-x-auto mt-5 pb-5 ">
                        <div class="text-white w-full flex flex-col gap-y-[15px]">
                            ...
                            <div
                                ...
                                <div class="w-full border-t border-b border-whiteOp-300 md:border-none py-5 md:py-0">
