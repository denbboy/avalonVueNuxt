  ...
  <header class=" z-30 transition-all absolute w-full">
    <div
      ...
      <div class="header__inner px-5 flex items-center justify-between gap-3 relative z-[2]">
        <div class="flex 3xl:gap-12 gap-6 items-center">
        ...
        <div class="flex 3xl:gap-7 gap-6 items-center">
          <button type="button" @click="handleOpenModal"
            class="xl:flex hidden border border-whiteOp-400 rounded-xl 2xl:p-4 py-3 px-4 text-white md:text-xs 3xl:text-sm font-bold hover:bg-white hover:text-blue-400 hover:border-white transition-all xl:justify-center">
            {{ $t('make_a_meeting') }}
          </button>
          <a :href="`https://wa.me/${toolkitStore?.settings?.phone?.replace(/[^\d+]/g, '')}`"
            class="xl:flex hidden items-center gap-1 text-white md:text-sm 3xl:text-base font-bold ">
          ...
          <div class="gap-1 hidden xl:flex">
            <a v-if="toolkitStore?.settings?.soc_link_whats" target="_blank" :href="`${toolkitStore?.settings?.soc_link_whats}`"
            ...
            <a v-if="toolkitStore?.settings?.soc_link_inst" target="_blank" :href="`${toolkitStore?.settings?.soc_link_inst}`"
              class="3xl:w-[48px] 3xl:h-[48px] md:w-[42px] md:h-[42px] border border-white rounded-full hover:bg-white transition-all flex items-center justify-center group">
            ...
            <a v-if="toolkitStore?.settings?.soc_link_fb" target="_blank" :href="`${toolkitStore?.settings?.soc_link_fb}`"
              class="3xl:w-[48px] 3xl:h-[48px] md:w-[42px] md:h-[42px] border border-white rounded-full hover:bg-white transition-all flex items-center justify-center group">
            ...
            <a v-if="toolkitStore?.settings?.soc_link_yt" target="_blank" :href="`${toolkitStore?.settings?.soc_link_yt}`"
