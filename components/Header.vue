<template>
  ...
  <header
    class="bg-blue-500 py-4 border-b-2 border-b-whiteOp-300 z-30 md:bg-transparent md:border-none transition-all absolute w-full">
    <div class="px-5">
      <div class="header__inner flex items-center justify-between gap-3 relative">
        <NuxtLink href="/">
          <img src="/assets/img/index/logo-desk.svg" class="hidden md:max-w-[55px] w-full lg:max-w-[80px] md:block" alt="logo">
          <img src="/assets/img/icons/logo-mob.svg" class="md:hidden" alt="logo ic">
        </NuxtLink>


        <div class="items-center md:gap-6 lg:gap-10 hidden md:flex">
          ...
          <NuxtLink href="/cooperation" class="text-white md:text-xs lg:text-sm relative
						before:block before:w-0 hover:before:w-2/3 before:h-[1px] before:bg-white before:absolute before:bottom-[-5px] before:left-0 before:transition-all before:duration-300
						after:block after:w-0 hover:after:w-2/3 after:h-[1px] after:bg-white after:absolute after:bottom-[-9px] after:right-0 after:transition-all after:duration-300
					">
            {{ $t('cooperation') }}
        ...
        <button type="button" @click="handleOpenModal"
          class="md:flex hidden border border-whiteOp-400 rounded-xl p-4 text-white md:text-xs lg:text-sm font-bold hover:bg-white hover:text-blue-400 hover:border-white transition-all xl:justify-center">
          {{ $t('make_a_meeting') }}
        </button>
        <a href="tel:+6281246502783" class="md:flex hidden items-center gap-1 text-white md:text-sm lg:text-base font-bold ">
        ...
        <div class="hidden group xl:flex xl:flex-col relative">
          ...
          <div
            ...
            <button @click="changeLocale('ua')" class="text-white md:text-xs lg:text-sm mb-4 hover:text-blue-400 transition-all">
              UA
            </button>
            <button @click="changeLocale('ru')" class="text-white md:text-xs lg:text-sm hover:text-blue-400 transition-all">
              RU
            </button>
          </div>
        </div>
        <div class="gap-1 hidden xl:flex">
          <a href="#"
            ...
            <svg class="fill-white w-1/2 group-hover:fill-blue-600 transition-all" width="25" height="25" viewBox="0 0 25 25"
          ...
          <a href="#"
            class="lg:min-w-[48px] lg:h-[48px] md:min-w-[42px] md:h-[42px] border border-white rounded-full hover:bg-white transition-all flex items-center justify-center group">
            <svg class="fill-white w-1/2 group-hover:fill-blue-600 transition-all" width="25" height="26" viewBox="0 0 25 26"
              xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a href="#"
            class="lg:min-w-[48px] lg:h-[48px] md:min-w-[42px] md:h-[42px] border border-white rounded-full hover:bg-white transition-all flex items-center justify-center group">
            <svg class="fill-white w-1/2 group-hover:fill-blue-600 transition-all" width="11" height="20" viewBox="0 0 11 20"
              xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a href="#"
            ...
            <svg class="fill-white w-1/2 group-hover:fill-blue-600 transition-all" width="20" height="14" viewBox="0 0 20 14"
              xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <button @click="handleOpenBurger" id="burgerBtn" type="button" class="md:hidden block ">
