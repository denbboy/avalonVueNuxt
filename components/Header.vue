<template>
  <header class="z-30 transition-all absolute w-full">
      ...
      <div class="header__inner px-5 flex items-center justify-between gap-3 relative z-[2]">
        ...
        <div class="flex ml-auto 3xl:gap-6 gap-6 items-center">
          ...
          <div class="hidden group xl:flex xl:flex-col relative">
            <button
              class="projectsButton flex items-center gap-1 text-white md:text-xs 3xl:text-base uppercase"
            >
              {{ locale }}
              <svg
                width="6"
          ...
          <div class="gap-1 hidden xl:flex">
            <a
              ...
              class="3xl:w-[48px] 3xl:h-[48px] md:w-[42px] md:h-[42px] border border-white rounded-full hover:bg-white transition-all flex items-center justify-center group"
            >
              <svg
            ...
            <a
              ...
              class="3xl:w-[48px] 3xl:h-[48px] md:hidden 3xl:flex md:w-[42px] md:h-[42px] border border-white rounded-full hover:bg-white transition-all flex items-center justify-center group"
            >
              <svg
                class="fill-white w-1/2 group-hover:fill-blue-600 transition-all"
                width="20"
    ...
    <LazyHeaderBurgerMenu
      v-if="isLessThenDesktop"
      v-model:isOpenBurger="isOpenBurger"
      :projectsStore="projectsStore"
      :langStore="langStore"
    />
...
const isLessThenDesktop = window?.innerWidth <= 1600;
...
onMounted(() => {
  ...
  // Get current locale from URL or i18n
  const urlLocale = route.path.match(/^\/([a-z]{2})(\/|$)/)?.[1];
  const currentLocale = urlLocale || $i18n.locale.value;
