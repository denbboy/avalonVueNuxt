      ...
      <div class="header__inner px-5 flex items-center justify-between gap-3 relative z-[2]">
        ...
        <div class="flex 3xl:gap-7 gap-6 items-center">
          ...
          <div class="gap-1 hidden xl:flex">
            <a v-if="toolkitStore?.settings?.soc_link_whats" target="_blank"
            ...
            <a v-if="toolkitStore?.settings?.soc_link_inst" target="_blank"
            ...
            <a v-if="toolkitStore?.settings?.soc_link_fb" target="_blank"
            ...
            <a v-if="toolkitStore?.settings?.soc_link_yt" target="_blank"
        ...
        <button @click="handleOpenBurger" id="burgerBtn" type="button" class="2xl:hidden block ">
