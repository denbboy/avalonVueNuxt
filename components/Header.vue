  ...
  <header
    ...
    <div class="px-5">
      <div class="header__inner flex items-center justify-between gap-3 relative">
        ...
        <a href="tel:+6281246502783" class="xl:flex hidden items-center gap-1 text-white md:text-sm lg:text-base font-bold ">
    ...
    <div id="burgerMenu"
          class="'burger__body absolute top-full transition-all w-full left-0 bg-blue-500 flex-col text-center pt-12 pb-8 text-white text-lg border-t-2 border-whiteOp-300 z-10'"
