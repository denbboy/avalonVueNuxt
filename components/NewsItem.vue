<template>
  <NuxtLink :to="`/news/${props?.item?.id}`" class="w-full rounded-[20px] overflow-hidden h-full group transition-all hover:shadow-[0px_10px_10px_0px_rgba(0,0,0,.1)] block">
    <div class="relative w-full">
      ...
      <img class="w-full rounded-[20px] h-[300px] object-cover"
