<template>
    <div class="bg-center absolute top-0 left-0 w-full h-[100%] -z-10 opacity-50">
        ...
        <div v-if="item?.video" class="h-full w-full">
            ...
            <iframe loading="lazy" :class="isVideoPlayed ? 'full-video' : ''" class="lg:scale-150 scale-[3] pointer-events-none w-full h-full" title="Avalon"
                frameborder="0"
    ...
    <div class="container">
        <div class="flex md:flex-row flex-col items-center" v-if="item?.projects?.length">
            ...
            <div  class="is-will-hidden w-full min-h-[200px]">
                <div :class="isVideoPlayed ? 'opacity-0 invisible' : 'opacity-100 visible'" class="banner__item__head md:flex items-center">
                ...
                <p :class="isVideoPlayed ? 'opacity-0 invisible' : 'opacity-100 visible'" class="text-white text-sm max-w-64 md:max-w-[600px] md:text-base mt-3 md:mt-12 md:mr-5"
            ...
            <button data-aos="fade-up" v-if="item?.video" @click="e => handlePlayVideo(e, item?.video)" type="button"
                ...
                <div class="relative flex items-center justify-center max-w-[95px] w-full xl:max-w-[165px]">
                    <NuxtImg src="/img/about/playBorder.svg" class="w-full hidden md:block" alt="ic" loading="lazy" />
        ...
        <div v-if="item?.strings?.length" :class="isVideoPlayed ? 'opacity-0 invisible' : 'opacity-100 visible'" class="flex justify-between items-end lg:mt-10 xl:mt-10 mt-10">
