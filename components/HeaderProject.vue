  ...
  <header class="z-30 transition-all absolute w-full">
      ...
      <div class="header__inner px-5 flex items-center justify-between gap-4 lg:gap-8 relative">
        ...
        <div class="flex items-center gap-4 lg:gap-8">
          ...
          <div class="items-center gap-[26px] 3xl:gap-9 hidden md:flex">
            ...
            <NuxtLink
              href="#location"
              class="text-white text-[12px] 3xl:text-base relative before:block before:w-0 hover:before:w-2/3 before:h-[1px] before:bg-white before:absolute before:bottom-[-5px] before:left-0 before:transition-all before:duration-300 after:block after:w-0 hover:after:w-2/3 after:h-[1px] after:bg-white after:absolute after:bottom-[-9px] after:right-0 after:transition-all after:duration-300"
            >
              {{ $t('location') }}
            </NuxtLink>
            <NuxtLink
            ...
            <div class="relative group">
              <button
                type="button"
                class="projectsButton flex items-center gap-1 text-white md:text-xs lg:text-sm before:block before:w-0 hover:before:w-2/3 before:h-[1px] before:bg-white before:absolute before:bottom-[-5px] before:left-0 before:transition-all before:duration-300 after:block after:w-0 hover:after:w-2/3 after:h-[1px] after:bg-white after:absolute after:bottom-[-9px] after:right-0 after:transition-all after:duration-300"
              >
                {{ $t('else_projects') }}
              ...
              >
                <NuxtLink
                  ...
                  :key="item.id"
                  class="text-white md:text-xs lg:text-sm last:mb-0 mb-4 whitespace-nowrap relative before:block before:w-0 hover:before:w-2/3 before:h-[1px] before:bg-white before:absolute before:bottom-[-5px] before:left-0 before:transition-all before:duration-300 after:block after:w-0 hover:after:w-2/3 after:h-[1px] after:bg-white after:absolute after:bottom-[-9px] after:right-0 after:transition-all after:duration-300"
                >
                  {{
                    item?.translations?.filter((item) =>
                      item.languages_code.toLowerCase().startsWith(langStore.lang.toLowerCase()),
        ...
        <div class="flex items-center gap-4 lg:gap-7">
          ...
          <a
            :href="`https://wa.me/${toolkitStore?.settings?.phone?.replace(/[^\d+]/g, '')}`"
            class="2xl:flex hidden items-center gap-1 text-white md:text-sm lg:text-base font-bold"
          >
            <svg
              width="19"
              height="19"
          ...
          <div class="hidden group xl:flex xl:flex-col relative">
            <button
              class="projectsButton flex items-center gap-1 text-white md:text-xs lg:text-sm uppercase"
            >
              {{ locale }}
              <svg
                width="6"
          ...
          <div class="gap-1 hidden 3xl:flex">
            <a
              target="_blank"
              v-if="toolkitStore?.settings?.soc_link_whats"
            ...
            >
              <svg
                class="fill-white w-1/2 group-hover:fill-blue-600 transition-all"
                width="25"
                height="25"
                viewBox="0 0 25 25"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              target="_blank"
              v-if="toolkitStore?.settings?.soc_link_inst"
            ...
            <a
              target="_blank"
              v-if="toolkitStore?.settings?.soc_link_fb"
            ...
            <a
              target="_blank"
              v-if="toolkitStore?.settings?.soc_link_yt"
    ...
    >
      <div class="md:hidden flex flex-col gap-8 mb-12 pb-7 border-b border-whiteOp-300">
        ...
        <div class="group burger__proj md:hidden block">
          ...
          >
            {{ $t('else_projects') }}
            <svg
              class="group-hover:-scale-y-100 transition-all"
              width="6"
              height="5"
              viewBox="0 0 6 5"
              fill="none"
            ...
            >
              <path
                class="fill-white group-hover:fill-blue-400 transition-all"
                d="M3.63428 3.93725L5.98828 0.25L0.00303125 0.25L2.36528 3.93575C2.43272 4.04304 2.52625 4.13149 2.63713 4.19285C2.74802 4.2542 2.87264 4.28646 2.99937 4.28661C3.12609 4.28676 3.25079 4.2548 3.36182 4.19371C3.47285 4.13261 3.56659 4.04438 3.63428 3.93725Z"
              />
            </svg>
          </p>
      ...
      <div class="flex flex-col gap-4">
        <a
          :href="`tel:${toolkitStore?.settings?.phone?.replace(/[^0-9+]/g, '')}`"
...
const changeLanguage = async (newLocale) => {
  ...
  // Get current route path and remove locale prefix
  const currentPath = route.path;
  ...
  // Ensure pathWithoutLocale doesn't start with double slash
