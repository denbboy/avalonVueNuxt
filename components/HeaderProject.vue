    ...
    <div class="header-wrapper w-full bg-blue-500 h-fit py-4 border-b-2 border-b-whiteOp-300 md:border-none transition-all"
      :class="isOpenBurger ? 'bg-blue-500' : 'md:bg-transparent'">
        ...
        <div class="header__inner px-5 flex items-center justify-between gap-3 relative">
          <NuxtLink :href="`/projects/${projectsStore.currentProject?.id}`">
            <!-- <img src="/assets/img/index/logo-desk.svg" class="hidden lg:min-w-[80px] lg:block" alt="logo"> -->
            <img :src="`https://avalon-panel.sonisapps.com/assets/${projectsStore.currentProject?.logo}`" class="max-w-20" alt="logo ic">
