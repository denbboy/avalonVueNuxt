<template>
  <footer id="contacts" class="mt-a bg-blue-600 pt-12 md:pt-24 mt-auto z-10">
    <h2 class="text-center text-white text-3xl font-bold mb-7 block lg:hidden">
      {{ $t('contacts') }}
    </h2>
    ...
    >
      <NuxtImg
        ...
        class="max-w-5 w-full relative z-10"
        alt="ic"
        loading="lazy"
      />
    ...
    <div class="container">
      <div
        ...
        :class="isShowArrowUp ? 'opacity-100' : 'opacity-0'"
      ...
      <div class="xl:flex xl:items-center gap-5 justify-between md:mb-24">
        ...
        <div class="hidden lg:block">
          <video
            ...
            @error="handleError"
            :src="
              'https://api.avalonbali.com/assets/' +
              toolkitStore?.settings?.footer_video +
              '?width=392&height=392&format=webm'
            "
          ></video>
          <NuxtImg
            v-else
        ...
        <div class="w-full xl:w-fit sm:flex justify-between xl:block">
          <div class="md:mb-[30px] md:pb-[30px] border-b border-white/10 mb-5 pb-5">
            ...
            <a
              :href="`mailto:${toolkitStore?.settings?.email}`"
              target="_blank"
              class="flex items-center gap-4 mb-7 md:gap-4 lg:gap-5 group"
            >
              <div
              ...
              <div>
                <span class="text-white/40 text-sm md:text-base md:mb-2"> Email us </span>
                <p
                  class="text-white font-bold text-sm md:text-[16px] 3xl:text-xl group-hover:text-blue-400 transition-all"
                >
          ...
          <div class="flex gap-[5px] mb-5">
            ...
            >
              <svg
                class="fill-white group-hover:fill-blue-600 w-[45%] transition-all"
                width="25"
                height="25"
                viewBox="0 0 25 25"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              aria-label="link"
              v-if="toolkitStore?.settings?.soc_link_tg"
              target="_blank"
            ...
            >
              ...
              <svg
                class="fill-white group-hover:fill-blue-600 transition-all"
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="40"
                viewBox="0 0 24 24"
        ...
        >
          <NuxtImg
            loading="lazy"
            src="/img/index/dot-decor-2.webp"
      ...
      <div class="container">
        <div class="flex items-center justify-between gap-8">
          ...
          <ul class="md:flex md:items-center py-2 md:justify-center md:w-full">
            ...
            >
              <NuxtLink
                :href="`/${langStore.lang === 'en' ? '' : langStore.lang + '/'}cooperation`"
            ...
            >
              <NuxtLink
                :href="`/${langStore.lang === 'en' ? '' : langStore.lang + '/'}career`"
                class="hover:text-blue-400 transition-all"
              >
                {{
                  pagesStore.pagesList
            ...
            >
              <NuxtLink
                :href="`/${langStore.lang === 'en' ? '' : langStore.lang + '/'}docs/privacy-police`"
                class="hover:text-blue-400 transition-all"
              >
                {{
                  pagesStore.pagesList
            ...
            >
              <NuxtLink
                :href="`/${langStore.lang === 'en' ? '' : langStore.lang + '/'}docs/terms`"
                class="hover:text-blue-400 transition-all"
              >
                {{
                  pagesStore.pagesList
