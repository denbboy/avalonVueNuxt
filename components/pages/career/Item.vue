        ...
        <div class="select career-select group" :class="{ 'active': isOpen }">
            <div class="select__head py-6 flex justify-between items-center cursor-pointer" @click="handleOpen">
                ...
                <div
                    ...
                    <img class="group-[.active]:block hidden" width="18" height="18" src="/img/icons/minus-white.svg" alt="Image" />
                    <img class="group-[.active]:hidden block" width="18" height="18" src="/img/icons/plus-white.svg" alt="Image" />
                </div>
            </div>
