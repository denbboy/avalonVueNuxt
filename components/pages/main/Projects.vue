<template>
  <section class="uslugi pt-[23px] pb-12 relative overflow-hidden">
    ...
    <div class="container">
      <div
        class="w-full flex flex-col items-center text-center md:flex-row md:justify-between md:mb-[44px] md:text-start"
        data-aos="fade-up"
      >
        <div class="">
      ...
      >
        <div
          ...
          v-for="(item, index) in projectsStore.projects"
          :key="item.id"
        >
          <div class="">
            <NuxtImg
              ...
              class="prev-img w-full h-full absolute object-cover opacity-50 transition-opacity duration-300 group-hover:opacity-100"
              alt="Image"
              loading="lazy"
            />
            ...
            <div class="absolute top-0 left-0 w-full h-full p-5 md:p-7 flex flex-col">
              ...
              <div class="flex justify-between mb-auto">
                <NuxtImg
                  class="w-[90px]"
                  v-if="item?.logo"
                  :src="`https://api.avalonbali.com/assets/${item?.logo}?width=90&height=120&format=webp`"
                  alt="Image"
                  loading="lazy"
                />
