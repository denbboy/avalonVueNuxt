<template>
    <section class="uslugi pt-[23px] pb-12 relative overflow-hidden">
        ...
        <div class="container">
            ...
            <div
                class="projects grid flex-col gap-5 grid-cols-3 flex-wrap items-center md:justify-between md:flex-row lg:flex-row z-10 relative">

                <div :class="getGridClasses(index)"
                    class="projects-item relative md:rounded-[14px] !rounded-br-none lg:rounded-3xl overflow-hidden bg-[#111111] lg:min-h-[500px] md:min-h-[400px]"
