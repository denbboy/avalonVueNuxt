<template>
  <section class="pb-12">
    ...
    <swiper class="swiper-banner" :modules="modules" :slides-per-view="1" :pagination="{ clickable: true }"
      ...
      <swiper-slide class="pt-40 lg:pt-[250px] relative overflow-hidden">
        <div class="container">
          <div class="flex items-center justify-between">
            <div class="">
              <div
                class="bg-[url('./../img/index/slide-bgd-1.jpg')] brightness-[0.4] bg-center absolute top-0 left-0 w-full h-[100%] -z-10 opacity-50">
                <iframe class="scale-125" width="100%" height="100%"
              ...
              <div class="banner__item__head md:flex">
                ...
                <div class="con md:ml-4 md:pl-5 md:px-7 relative">
                  ...
                  <div class="relative px-5 py-3 w-fit md:text-center">
                    ...
                    <h2 class="text-sm text-white">
                      Стоимость <br class="hidden md:block"> <span class="whitespace-nowrap font-bold md:text-xl">от
                        $70.000</span>
                    </h2>
            ...
            <div class="flex gap-5">
              <div class="pr-5 border-r border-whiteOp-300">
                ...
                <span class="text-white text-sm md:text-base">
                  Возврат <br class="md:hidden">инвестиций
                </span>
              </div>
              <div>
                <p class="font-bold text-white text-2xl mb-2 md:text-4xl md:mb-3">
                ...
                <span class="text-white text-sm md:text-base">
                  Средняя <br class="md:hidden">доходность
                </span>
              </div>
            </div>
          </div>
      ...
      <swiper-slide class="pt-40 lg:pt-[250px] relative overflow-hidden">
        <div
          class="bg-[url('./../img/index/slide-bgd-2.jpg')] bg-center absolute top-0 left-0 w-full h-[100%] -z-10 opacity-50">
        </div>
        ...
        <div class="container">
          <div class="banner__item__head md:flex items-center">
            <img src="/assets/img/index/Budha-logo.svg" class="mb-7 md:mb-0" alt="logo">
          ...
          <p class="text-white text-sm max-w-64 md:max-w-[416px] md:text-base mt-3 md:mt-12">
            Апарт отель для инвестиций в сердце Чангу, район Берава. Топовая локация в 700 метрах от пляжа.
      ...
      <swiper-slide>
        <div class="pb-10 pt-36 lg:pt-[290px] relative overflow-hidden">
          <div
            class="banner bg-[url('./../img/about/about-banner.jpg')] max-w-none bg-center absolute top-0 left-0 w-full h-screen -z-10 opacity-50">
            <iframe class="scale-125" width="100%" height="100%" src="" title="YouTube video player" frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          </div>
          <div class="bg-gradient-to-t from-blue-500 from-30% w-full h-52 absolute -z-10 bottom-0 left-0"></div>
          ...
          <div class="container">
            <div class="md:flex md:justify-between md:gap-10">
              <div>
                <div class="banner__item__head flex flex-wrap items-center gap-[10px] md:gap-5">
                  ...
                  <div class="con order-1 md:order-none">
                    <div class="relative px-5 py-3 w-fit md:text-center md:px-7">
                      <img class="absolute top-0 left-0 -z-10 md:hidden" src="/assets/img/index/bgd-decor.png"
                        alt="bgd">
                      <img class="absolute top-0 left-0 -z-10 hidden md:block h-[-webkit-fill-available]"
                        src="/assets/img/index/bgd-decor-2.png" alt="bgd">
                      <h2 class="text-sm text-white">
                    ...
                    <svg width="68" height="48" viewBox="0 0 68 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_840_7506)">
                        <path
                          ...
                          fill="#F70000" />
                        <path d="M26.8868 37.2038H19.6875V24.6454H21.9838V35.1488H26.8868V37.2038Z" fill="white"
              ...
              <div class="flex flex-col md:mt-10">
                <button @click="handlePlayVideo" type="button"
                  class="flex items-center mb-10 gap-5 text-white text-sm md:text-base md:flex-col md:ml-auto">
                  <img src="/assets/img/icons/play-video-A.svg" class="max-w-[95px] md:max-w-[165px]" alt="ic">
                  Посмотреть видео
                </button>
                <div class="flex gap-[10px] md:gap-5 md:mt-[100px] lg:grid lg:grid-cols-[repeat(3,_240px)]">
                  ...
                  <div class="pb-[15px] border-b border-whiteOp-300 md:pb-[30px] w-full lg:order-1">
                    <h3
                      ...
                      17%
                      <img src="/assets/img/icons/about-banner-A-ic.svg" class="max-w-[20px] md:max-w-[30px]" alt="ic">
                    </h3>
                    <p class="text-white text-sm md:text-base">
