<template>
  <section class="pb-12">
    ...
    <swiper class="swiper-banner" :modules="modules" :slides-per-view="1" :pagination="{ clickable: true }"
      @swiper="onSwiper" @slideChange="onSlideChange" :autoplay="{ delay: 3000, disableOnInteraction: false }" :speed="1500">

      <swiper-slide class="pt-40 lg:pt-[250px] relative overflow-hidden">
        <div class="container">
          <div class="flex items-center justify-between">
            <div class="">
              <div class="bg-[url('./../img/index/slide-bgd-1.jpg')] brightness-[0.4] bg-center absolute top-0 left-0 w-full h-[100%] -z-10 opacity-50">
                <iframe class="scale-125" width="100%" height="100%" src="https://www.youtube.com/embed/zHcr32gRRCs?si=73xg2tsfV1tnZjwg&autoplay=1&mute=1&loop=1&playlist=zHcr32gRRCs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
              </div>
              ...
              <div class="banner__item__head md:flex">
                ...
                <div class="con md:ml-4 md:pl-5 md:px-7 relative">
                  ...
                  <div class="relative px-5 py-3 w-fit md:text-center">
                    <img class="absolute top-0 left-0 -z-10 md:hidden h-full" src="/assets/img/index/bgd-decor.png" alt="bgd">
                    <img class="absolute top-0 left-0 -z-10 hidden md:block h-full" src="/assets/img/index/bgd-decor-2.png"
                      alt="bgd">
