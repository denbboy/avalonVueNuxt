<template>
  <section class="bg-white pt-14 relative overflow-hidden">
    <div class="absolute -left-14 lg:-left-36 bottom-0 lg:bottom-5 w-28 lg:w-72 lg:h-72 z-10">
      <img loading="lazy" src="/img/icons/vector-logo.svg" class="invert w-full" alt="vector-logo" />
    </div>
      ...
      <div>
        <div class="flex justify-between items-center mb-8">
          ...
          <div class="w-fit hidden md:flex" data-aos="fade-up">
            <NuxtLinkLocale to="/sales" class="mr-12 text-blue-600 font-bold underline hover:no-underline">
              {{ $t('all_sales') }}
            </NuxtLinkLocale>
        ...
        <NuxtLinkLocale to="/sales" class="blue-border-button mx-auto mt-5 md:hidden">
          {{ $t('all_sales') }}
        </NuxtLinkLocale>
