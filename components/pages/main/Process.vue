<template>
  <section class="bg-no-repeat bg-cover pt-14 pb-32 relative overflow-hidden">
    ...
    >
      ...
      <NuxtImg
        class="h-full w-full object-cover scale-[1.7]"
        src="/img/about/process.webp"
        width="1920"
        height="1200"
        alt="image"
      />
    ...
    <div class="container relative z-10">
      ...
      >
        <NuxtImg
          loading="lazy"
          src="/img/index/buy-bg-desk.png"
          class="absolute top-0 left-0 w-full h-full z-0 hidden md:block backdrop-blur-[1px]"
          alt="Image"
        />
        <NuxtImg
          loading="lazy"
          src="/img/index/buy-list-bg.png"
          class="absolute top-0 left-0 w-full h-full z-0 block md:hidden backdrop-blur"
          alt="Image"
        />

        <div
          class="md:flex hidden absolute w-[150px] lg:w-[240px] items-center right-0 top-[140px]"
        >
        ...
        <svg
          class="absolute left-1/2 -translate-x-1/2 top-0 md:hidden"
          width="10"
          height="45"
          viewBox="0 0 10 45"
          fill="none"
        ...
        <div class="mb-7 md:flex md:items-center md:mb-[50px] relative z-10">
          <h2
            class="font-bold text-white max-w-[580px] text-3xl mb-7 md:text-[45px] md:leading-[45px] lg:text-[56px] lg:leading-[56px] md:text-left md:m-0"
            data-aos="fade-up"
          >
            {{
              itemStrings
                ?.filter((item) => item.id === 136)[0]
                ?.String_id?.translations?.filter((item) =>
                  item.languages_code.code.includes(locale),
                )[0]?.title
            }}
          </h2>
          <p
            class="text-white/60 opacity-50 text-sm md:text-sm lg:text-base md:text-left md:ml-5 md:mr-24 max-w-[360px] lg:max-w-[500px]"
            data-aos="fade-up"
          >
            {{
              itemStrings
          ...
          >
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white font-bold text-xs lg:text-lg"> 1 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 138)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white font-bold text-xs lg:text-lg"> 2 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 139)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white font-bold text-xs lg:text-lg"> 3 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 140)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white font-bold text-xs lg:text-lg"> 4 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 141)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white font-bold text-xs lg:text-lg"> 5 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 142)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white hidden md:block font-bold text-xs lg:text-lg"> 10 </span>
                  <span class="text-white flex md:hidden font-bold text-xs lg:text-lg"> 6 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 147)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white hidden md:block font-bold text-xs lg:text-lg"> 9 </span>
                  <span class="text-white flex md:hidden font-bold text-xs lg:text-lg"> 7 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 146)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white hidden md:block font-bold text-xs lg:text-lg"> 8 </span>
                  <span class="text-white flex md:hidden font-bold text-xs lg:text-lg"> 8 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 145)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white hidden md:block font-bold text-xs lg:text-lg"> 7 </span>
                  <span class="text-white flex md:hidden font-bold text-xs lg:text-lg"> 9 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 144)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
            ...
            <li class="mb-5 flex items-center md:flex-col">
              ...
              >
                ...
                >
                  <span class="text-white hidden md:block font-bold text-xs lg:text-lg"> 6 </span>
                  <span class="text-white flex md:hidden font-bold text-xs lg:text-lg"> 10 </span>
                </div>
              </div>
              <p class="text-white text-sm md:text-xs lg:text-base md:text-center">
                {{
                  itemStrings
                    ?.filter((item) => item.id === 143)[0]
                    ?.String_id?.translations?.filter((item) =>
                      item.languages_code.code.includes(locale),
                    )[0]?.title
                }}
        ...
        <div
          class="md:flex relative z-10 md:flex-row-reverse md:justify-between md:items-center md:pt-10 md:border-t md:border-whiteOp-300"
          data-aos="fade-up"
        >
          <button
          ...
          <div class="flex items-center gap-4 lg:gap-10">
            <NuxtImg
              loading="lazy"
              src="/img/index/a-decor-op.svg"
              class="hidden md:block md:max-w-[112px]"
              alt="decor"
            />
        ...
        >
          ...
          ></div>
          <b
            class="block font-bold text-white md:text-[45px] lg:text-[60px] leading-[100%] text-[40px] md:mb-3"
          >
            {{
              itemStrings
                ?.filter((item) => item.id === 137)[0]
                ?.String_id?.translations?.filter((item) =>
                  item.languages_code.code.includes(locale),
                )[0]?.title
            }}
...
watchEffect(() => {
  ...
  if (isProjectPage) {
    itemStrings.value =
      props.itemStrings ??
      (blocksStore.blocks?.filter((item) => item?.id === 31)[0]?.strings || []);
  } else {
...
watch(props, async (newValue) => {
  if (window.location.href.includes('/projects/')) {
    itemStrings.value =
      newValue.itemStrings ?? newValue.blocks?.filter((item) => item?.id === 31)[0];
  }
});
