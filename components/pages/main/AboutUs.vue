      ...
      <div class="md:flex md:items-center gap-8 justify-between">
        <div class="w-full">
          <div class="flex items-center mb-8 md:mb-10" data-aos="fade-up">
            <NuxtImg loading="lazy" src="/assets/img/index/a-us-decor.svg" class="max-w-[60px] mr-4 md:max-w-[80px] md:mr-5" alt="ic a" />
        ...
        <div class="relative mt-7 w-full md:max-w-[567px] lg:max-w-[760px] ">
          ...
          <NuxtImg loading="lazy" src="/assets/img/index/about-photo.png" class="w-full relative z-10" alt="ph" data-aos="fade-left" />
        </div>
      </div>
    </div>
  </section>
