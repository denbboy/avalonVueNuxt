<template>
  <section class="company md:bg-white md:pt-24 md:pb-16 relative overflow-hidden bg-blue-600" data-aos="fade-up">
    <div class="absolute -left-36 bottom-20 w-72 h-72 z-10">
      <img src="/img/icons/vector-logo.svg" class="invert w-full" alt="vector-logo" />
    </div>
    ...
    <div class="container">
      <div class="relative md:h-[450px] list">
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/img/index/comp-1.svg" class="ml-5 md:m-auto md:w-[141px] " alt="ic" />
          </div>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/img/index/comp-2.svg" class="ml-5 md:m-auto md:w-[141px]" alt="ic" />
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_2') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/img/index/comp-3.svg" class="ml-5 md:m-auto md:w-[125px]" alt="ic" />
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_3') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/img/index/comp-4.svg"
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/img/index/comp-5.svg" class="ml-5 md:m-auto md:w-[200px]" alt="ic" />
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_5') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/img/index/comp-6.svg" class="ml-5 md:m-auto md:w-[160px]" alt="ic" />
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_6') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/img/index/comp-7.svg" class="ml-5 md:m-auto md:w-[140px]" alt="ic" />
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_7') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/img/index/comp-8.svg" class="ml-5 md:m-auto md:w-[200px]" alt="ic" />
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_8') }}
          </p>
