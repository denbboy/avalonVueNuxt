    ...
    <div class="container">
      <div class="relative md:h-[450px]">
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/assets/img/index/comp-1.svg" class="ml-5 md:m-auto md:w-[141px] " alt="ic">
          </div>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/assets/img/index/comp-2.svg" class="ml-5 md:m-auto md:w-[141px]" alt="ic">
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_2') }}
          </p>
        ...
        <div
          class="bg-[#E7EDF2] w-[calc(100%_+_60px)] ml-[-30px] px-[30px] py-[30px] grid grid-cols-2 items-center md:flex relative md:bg-white md:max-w-64 md:flex-col md:p-0 md:gap-4 md:absolute z-10 md:top-[18%] md:left-[20%] lg:left-[27%]">
          <div
            class="bg-blue-400 min-w-2 h-2 rounded-[3px] before:block before:w-[50px] before:h-[1px] before:bg-blue-400/20 before:absolute before:right-[0] before:top-1 absolute top-[50%] left-5 translate-y-[-50%] md:left-[50%] md:top-[-20px] md:translate-x-[-50%] md:before:w-[1px] md:before:h-[400px] md:before:bottom-0 md:before:top-auto md:before:right-1">
          </div>

          <div class="w-full">
            <img loading="lazy" src="/assets/img/index/comp-3.svg" class="ml-5 md:m-auto md:w-[125px]" alt="ic">
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_3') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/assets/img/index/comp-4.svg" class="ml-5 md:m-auto md:w-[200px] md:-mt-5 md:pt-5 md:bg-white"
              alt="ic">
          </div>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/assets/img/index/comp-5.svg" class="ml-5 md:m-auto md:w-[200px]" alt="ic">
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_5') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/assets/img/index/comp-6.svg" class="ml-5 md:m-auto md:w-[160px]" alt="ic">
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_6') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/assets/img/index/comp-7.svg" class="ml-5 md:m-auto md:w-[140px]" alt="ic">
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_7') }}
          </p>
        ...
        <div
          ...
          <div class="w-full">
            <img loading="lazy" src="/assets/img/index/comp-8.svg" class="ml-5 md:m-auto md:w-[200px]" alt="ic">
          </div>
          <p class="text-blue-600 text-xs md:text-center md:max-w-[222px] md:mx-auto">
            {{ $t('companies_text_8') }}
          </p>
