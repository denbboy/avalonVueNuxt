      ...
      <div class="">
        <div class="flex justify-between items-center mb-8">
          ...
          <div class="w-fit hidden md:flex" data-aos="fade-up">
            ...
            <button type="button" class=" transition-all opacity-20 hover:opacity-100 news-button-prev mr-9">
            ...
            <button type="button" class=" transition-all opacity-20 hover:opacity-100 news-button-next">
              <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
