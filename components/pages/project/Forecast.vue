<template>
    <section id="investors"
        class="prognoz  bg-[url('./../img/about/prognoz-bgd.png')] bg-no-repeat bg-cover py-14 md:py-24">
        <div class="container">
            <h2 data-aos="fade-up"
                class="text-white text-3xl font-bold mb-[30px] md:text-center md:text-[56px] md:mb-[50px]">
                {{ $t('forecast') }} ROI
            </h2>
            ...
            <div class="">
                <div data-aos="fade-up" class="flex w-full">
                    <div class="w-full mb-[15px] md:mb-[30px]">
                        ...
                        <label for="option1" class="py-[17px] md:py-[23px] px-2 w-full flex transition-all justify-center font-bold text-[#FFFFFF66] text-sm md:text-base border-b border-[#FFFFFF66] cursor-pointer">
                            {{ $t('appatments') }}
                        </label>
                    </div>
                    <div class="w-full">
                        <input @change="handleChange" type="radio" name="data1" value="option2" id="option2"
                            class="sr-only">
                        <label for="option2" class="py-[17px] md:py-[23px] px-2 w-full flex transition-all justify-center font-bold text-[#FFFFFF66] text-sm md:text-base border-b border-[#FFFFFF66] cursor-pointer">
                            {{ $t('vills') }}
                        </label>
                    </div>
                </div>
                ...
                <Transition>
                    <div v-if="type === 'option1'"
                        class="bg-blue-600 rounded-2xl px-5 py-[30px] md:p-[30px]  3xl:p-[50px]">
                        <div
                            class="xl:flex xl:items-center xl:justify-between xl:gap-[52px] pb-5 xl:pb-[50px] border-b border-whiteOp-300">
                            <h2 class="text-white font-bold text-2xl mb-5 md:text-2xl lg:max-w-80 3xl:text-3xl lg:mb-0">
