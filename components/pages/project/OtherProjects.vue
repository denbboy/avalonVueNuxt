<template>
  <section class="uslugi pt-[23px] pb-12 md:py-24 relative overflow-hidden">
    <div
      class="absolute lg:-right-36 top-0 lg:top-auto lg:left-auto lg:bottom-40 -left-14 w-28 lg:w-72 z-[2]"
    >
    ...
    <div class="container">
      ...
      >
        <div
          class="relative rounded-[14px] !rounded-br-none lg:rounded-3xl overflow-hidden bg-[#111111] min-h-[500px] lg:min-h-[600px] md:min-h-[400px]"
          v-for="item in props.projects"
          :key="item.related_Project_id?.id"
        >
          <div class="">
            <NuxtImg
              :src="`https://api.avalonbali.com/assets/${item.related_Project_id?.preview}?width=550&height=600&format=webp`"
            ...
            <div class="absolute top-0 left-0 w-full h-full p-5 md:p-7 flex flex-col">
              ...
              <div class="flex justify-between mb-auto">
                <NuxtImg
                  class="w-[90px]"
                  v-if="item.related_Project_id?.logo"
                  :src="`https://api.avalonbali.com/assets/${item.related_Project_id?.logo}?width=90&height=120&format=webp`"
                  alt="Image"
                  loading="lazy"
                />
                <span
              ...
              <div class="max-w-96">
                ...
                <div
                  ...
                  "
                  class="text-white text-xs md:text-[11px] lg:text-sm mb-5"
                ></div>
                <div
                  v-if="
                    item?.related_Project_id.is_price_show &&
                    item?.related_Project_id.price &&
                    item?.related_Project_id.price_local
                  "
