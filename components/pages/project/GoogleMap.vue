<template>
  ...
  <section id="location" class="map py-14 md:py-24 relative overflow-hidden">
    ...
    <div class="container relative z-10">
      ...
      <div class="overflow-hidden rounded-t-2xl lg:mb-0 lg:rounded-none lg:rounded-t-2xl">
      ...
      <div
        class="flex flex-col md:flex-row mt-[30px] md:items-center md:justify-between gap-[30px] md:gap-5 md:py-10 md:px-7 md:border md:border-whiteOp-300 md:rounded-b-2xl md:mt-[-1px]">
