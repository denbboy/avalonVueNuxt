<template>
  ...
  <section id="location" class="map py-14 md:py-24 relative overflow-hidden">
    ...
    <div class="container relative z-10">
      ...
      <a v-if="props.itemData?.location_link" :href="props.itemData?.location_link" target="_blank" class="text-white rounded-b-2xl md:rounded-none bg-[#0E88EC] w-full h-[40px] md:h-[60px] flex gap-[10px] justify-center items-center">
